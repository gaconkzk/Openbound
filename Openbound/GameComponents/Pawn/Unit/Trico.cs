...
namespace OpenBound.GameComponents.Pawn.Unit
{
    public class Trico : Mobile
    {
        public Trico(Player player, Vector2 position) : base(player, MobileType.Trico)
        {
            ...
            MobileFlipbook = MobileFlipbook.CreateMobileFlipbook(MobileType.Trico, position);
        ...
        protected override void Shoot()
        {
            ...
            if (SelectedShotType == ShotType.S1)
                LastCreatedProjectileList.Add(new IceProjectile1(this));
            else if (SelectedShotType == ShotType.S2)
                LastCreatedProjectileList.Add(new IceProjectile2(this));
