...
namespace OpenBound.GameComponents.Interface
{
    ...
    public class Cursor
    {
        private static Dictionary<MouseCursorState, Flipbook> FlipbookDictionary
            ...
            {
                { MouseCursorState.Idle,       Flipbook.CreateFlipbook(default, default,                22, 22, "Interface/Cursor/Cursor",      new AnimationInstance() { StartingFrame = 0, EndingFrame = 16, TimePerFrame = 0.1f },                                          true, DepthParameter.Cursor) },
                { MouseCursorState.Click,      Flipbook.CreateFlipbook(default, default,                22, 22, "Interface/Cursor/CursorClick", new AnimationInstance() { StartingFrame = 0, EndingFrame = 09, TimePerFrame = 0.2f },                                          true, DepthParameter.Cursor) },

                { MouseCursorState.DragCamera, Flipbook.CreateFlipbook(default, new Vector2(11, 11),    22, 22, "Interface/Cursor/DragCamera",  new AnimationInstance() { StartingFrame = 0, EndingFrame = 4, TimePerFrame = 0.1f, AnimationType = AnimationType.FowardStop }, true, DepthParameter.Cursor) },
                { MouseCursorState.DragShot,   Flipbook.CreateFlipbook(default, new Vector2(12, 11.5f), 24, 23, "Interface/Cursor/DragShot",    new AnimationInstance() { StartingFrame = 0, EndingFrame = 5,  TimePerFrame = 0.1f },                                          true, DepthParameter.Cursor) },

                { MouseCursorState.ScrollN,   Flipbook.CreateFlipbook(default, new Vector2(12, 0),      24, 23, "Interface/Cursor/ScrollN",     new AnimationInstance(){ StartingFrame = 0, EndingFrame = 7,  TimePerFrame = 0.1f },                                           true, DepthParameter.Cursor) },
                { MouseCursorState.ScrollS,   Flipbook.CreateFlipbook(default, new Vector2(12, 23),     24, 23, "Interface/Cursor/ScrollS",     new AnimationInstance(){ StartingFrame = 0, EndingFrame = 7,  TimePerFrame = 0.1f },                                           true, DepthParameter.Cursor) },
                { MouseCursorState.ScrollE,   Flipbook.CreateFlipbook(default, new Vector2(23, 12),     24, 23, "Interface/Cursor/ScrollE",     new AnimationInstance(){ StartingFrame = 0, EndingFrame = 7,  TimePerFrame = 0.1f },                                           true, DepthParameter.Cursor) },
                { MouseCursorState.ScrollW,   Flipbook.CreateFlipbook(default, new Vector2(0, 11.5f),   24, 23, "Interface/Cursor/ScrollW",     new AnimationInstance(){ StartingFrame = 0, EndingFrame = 7,  TimePerFrame = 0.1f },                                           true, DepthParameter.Cursor) },

                { MouseCursorState.ScrollNE,  Flipbook.CreateFlipbook(default, new Vector2(24, 0),      24, 23, "Interface/Cursor/ScrollNE",    new AnimationInstance(){ StartingFrame = 0, EndingFrame = 7,  TimePerFrame = 0.1f },                                           true, DepthParameter.Cursor) },
                { MouseCursorState.ScrollNW,  Flipbook.CreateFlipbook(default, default,                 24, 23, "Interface/Cursor/ScrollNW",    new AnimationInstance(){ StartingFrame = 0, EndingFrame = 7,  TimePerFrame = 0.1f },                                           true, DepthParameter.Cursor) },
                { MouseCursorState.ScrollSE,  Flipbook.CreateFlipbook(default, new Vector2(24, 23),     24, 23, "Interface/Cursor/ScrollSE",    new AnimationInstance(){ StartingFrame = 0, EndingFrame = 7,  TimePerFrame = 0.1f },                                           true, DepthParameter.Cursor) },
                { MouseCursorState.ScrollSW,  Flipbook.CreateFlipbook(default, new Vector2(0, 23),      24, 23, "Interface/Cursor/ScrollSW",    new AnimationInstance(){ StartingFrame = 0, EndingFrame = 7,  TimePerFrame = 0.1f },                                           true, DepthParameter.Cursor) },
            };
