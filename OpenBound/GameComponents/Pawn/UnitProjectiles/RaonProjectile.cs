...
namespace OpenBound.GameComponents.Pawn.UnitProjectiles
{
    ...
    {
        public RaonProjectile1(Raon mobile) : base(mobile, ShotType.S1, Parameter.ProjectileIceS1ExplosionRadius, Parameter.ProjectileIceS1BaseDamage)
        {
    ...
    {
        public RaonProjectile2(Raon mobile) : base(mobile, ShotType.S2, Parameter.ProjectileIceS2ExplosionRadius, Parameter.ProjectileIceS2BaseDamage)
        {
            this.Mobile = mobile;
    ...
    {
        public RaonProjectile3(Raon mobile) : base(mobile, ShotType.SS, Parameter.ProjectileIceSSExplosionRadius, Parameter.ProjectileIceSSBaseDamage)
        {
            this.Mobile = mobile;
