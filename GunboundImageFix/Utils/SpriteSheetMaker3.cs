...
namespace GunboundImageFix.Utils
{
    class SpritesheetMaker3
    {
        ...
        void CreateNewSpritesheet()
        {
            ...
            int spritesPerLine = Int32.Parse(Console.ReadLine());
            ...
            Color[][] newImageMatrix = ImageProcessing.CreateBlankColorMatrix((maxXSize * spritesPerLine), maxYSize * (int)Math.Ceiling(importedImageList.Count / (double)spritesPerLine));
